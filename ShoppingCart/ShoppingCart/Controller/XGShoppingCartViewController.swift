//
//  XGShoppingCartViewController.swift
//  ShoppingCart
//
...
class XGShoppingCartViewController: UIViewController {
    
    // MARK: - 属性
    // 已经添加进购物车的商品模型数组，初始化
    var addGoodArray: [XGGoodModel]? {
        didSet {
    ...
    // 商品列表cell的重用标识符
    private let shoppingCartCellIdentifier = "shoppingCartCell"
    ...
    private func prepareUI() {
        ...
        // 注册cell
        tableView.registerClass(XGShoppingCartCell.self, forCellReuseIdentifier: shoppingCartCellIdentifier)
    ...
    lazy var totalPriceLabel: UILabel = {
        ...
        let attributeText = NSMutableAttributedString(string: "总共价格：\(self.price)")
...
extension XGShoppingCartViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier(shoppingCartCellIdentifier, forIndexPath: indexPath) as! XGShoppingCartCell
...
// MARK: - XGShoppingCartDelegate数据、代理
extension XGShoppingCartViewController: XGShoppingCartCellDelegate {
...
// MARK: ---- view上的一些时间处理
extension  XGShoppingCartViewController {
