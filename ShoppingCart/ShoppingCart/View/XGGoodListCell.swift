 ...
 *  这是一个协议？目前不知道是做什么的
 */
protocol XGGoodListCellDelegate: NSObjectProtocol {
    
    func goodListCell(cell: XGGoodListCell, iconView: UIImageView)
}

class XGGoodListCell: UITableViewCell {
 ...
 /// 懒加载
    ...
    // 代理属性
    weak var delegate: XGGoodListCellDelegate?
